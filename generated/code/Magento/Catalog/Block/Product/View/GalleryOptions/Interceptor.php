...
class Interceptor extends \Magento\Catalog\Block\Product\View\GalleryOptions implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getOptionsJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getOptionsJson();
        } else {
            return $this->___callPlugins('getOptionsJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFSOptionsJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getFSOptionsJson();
        } else {
            return $this->___callPlugins('getFSOptionsJson', func_get_args(), $pluginInfo);
        }
    }
